    ...
    <>
      ...
      <div className="h-full">
        ...
        <div className="max-w-xs mx-auto m-4">
          <div className="relative flex flex-col h-full bg-indigo-600 shadow-lg rounded-lg shadow-lg pb-5 pt-5">
            {/* <!-- Date badge --> */}
            ...
            <header className="pb-4 mb-4 border-b border-indigo-200 border-opacity-30 text-center">
              ...
              <div className="font-extrabold mb-1">
                <span className="text-xl text-indigo-200 m-2">
                  <CalendarOutlined />
                </span>
            ...
            {(isExpanded || isExpandAll) && (
              <>
                ...
                <div className='text-md mb-12 text-white mb-24 text-white m-5'>
                  {job.skills}
                </div>
              </>
            )}
            <button className="m-5 cursor-pointer font-semibold text-sm inline-flex items-center justify-center px-3 py-2 border border-transparent rounded leading-5 shadow transition duration-150 ease-in-out bg-white hover:bg-indigo-500 hover:text-white text-indigo-500 focus:outline-none focus-visible:ring-2" onClick={toggleExpand}>
